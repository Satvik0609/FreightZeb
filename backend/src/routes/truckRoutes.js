...
const {
    createTruck, getMyTrucks, getDealerProfitOpportunities, getTruckShipmentMatches,
    getAllTrucks, getAvailableTrucks,
...
router.get('/my/profit-opportunities', restrictTo('DEALER', 'CARGO_DEALER'), getDealerProfitOpportunities);
...
router.patch('/:id/location', restrictTo('DEALER', 'CARGO_DEALER', 'ADMIN'), locationRules, validate, updateTruckLocation);
